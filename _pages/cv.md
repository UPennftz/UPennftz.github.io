...
* 数据分析与开发
* 2021年02月-2021年04月
* 参与浙江图胜数字科技有限公司人工智能大数据分析平台建设，提取宏观经济数据、细分产业数据和金融数据，接入[国际智能数据有限公司(新加坡)](https://www.hangzhou.gov.cn/art/2021/11/26/art_1229505914_3973091.html)的数据分析工具，提供经济学理论支持帮助构建综合评价体系与选择测度指标，并利用统计学建模优化指标计算过程。
* 参与浙江数洋科技有限公司杭州产业大脑平台建设，与区经信局和国网杭州对接，参与镇企业运行预警器项目，进行电力数据数字化试点，深度参与项目申报、场地进驻、数据构架等流程，自动监控电力流量并识别风险，生成并发送预警报告以帮助决策，利用统计学理论为模型参数和阈值调整提供支持，提升风险识别的准确率10%和精确度5%。
* 撰写、补充和校对《图胜科技：中国宏观经济数据分析——工业经济》文字分析与可视化图表。
* 市两会议期间，对200余份委员提案进行分词并统计词频，提取关键字并绘制词云图。
* 收集东盟十国财经新闻和市场信息，对东盟进行高频与深度经贸分析，每周产出1篇相关财经简报。
